...
// IS 247
// 02/13/2022
// program description: this is a program for a game where a player plays to escape an abandoned house
   ...
   //default construct
    ...
    public boolean hallway() {
       ...
       //asks the player to enter a number from 1-3
        ...
        boolean choiceResult = false; // initializes the result of going through a door
        ...
        if (choice == door2) {
            ...
            choiceResult = theDoor2();// the player went through door 1
        }
        if (choice == door3) {

            choiceResult = theDoor3();// the player went through door 1
        }
        return choiceResult;
    }
    ...
    public boolean theDoor2() {
        ...
        System.out.println(" Now you have the key to door2. This  door leads you to a basement" +
                ...
                " to enter the correct password ");// informs the player of the situation  behind door 2
        System.out.println("\npassword hint: " + number1 + "+" + number2
                + " space " + number3 + "*" + number4);// allows the player to answer the math question asked
        Scanner input = new Scanner(System.in);
        // takes their input
        ...
        if (Ans1 == total && Ans2 == product) {
            return true;// returns true if they are correct
        }
        else {
            System.out.println("WRONG PASSWORD!");
            return false;// returns false if they are wrong
        }
    }
